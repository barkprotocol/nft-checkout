...
export const POST = async (req: Request) => {
    try {
        ...
        // Ensure totalParticipants and bountyAmount are positive numbers
        if (totalParticipants <= 0 || bountyAmount <= 0) {
            return NextResponse.json({
                message: "Invalid Data: Total participants and bounty amount must be positive numbers.",
            }, { status: 422 });
        }
